...
# Time points
t = t = [0, 6, 12, 24, 36, 48, 60, 72, 84, 96] # np.linspace(0, 25, 10, dtype='int')
...
for r in range(N):
    ...
    np.save(f'Trifurcation/True/inter_{r+1}', inter)
    np.save(f'Trifurcation/True/inter_{r + 1}_fordist', model.inter)
    ...
    fname = f'Trifurcation/Data/data_{r+1}.txt'
